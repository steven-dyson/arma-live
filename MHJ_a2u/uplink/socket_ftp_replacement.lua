...
-----------------------------------------------------------------------------
-- REST support added by MaHuJa
-- To use, gettable.command = "REST 50\nRETR"
-- The difference is around line 150
--	local code = self.try(self.tp:check{"1..", "2..", "350"})
--	if code==350 then code = self.try(self.tp:check{"1..", "2.."}) end
-----------------------------------------------------------------------------
