...
EXAMPLE:
_null = [object, [sides] (WEST, EAST, CIV), type ("vehicle_basic", "vehicle_adv"), text (string), icon (see cfgMarkers), direction, color, update interval] spawn SPY_meSys_fnc_marker;
****************************************************************************/
...
if ((isNil "_markerName")) then {
	...
	_markerName = format ["SPY_meSys_fnc_marker_%1_%2_%3", (_position select 0), (_position select 1), (_position select 2)];
