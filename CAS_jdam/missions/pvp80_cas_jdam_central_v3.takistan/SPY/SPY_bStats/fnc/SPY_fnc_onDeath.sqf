/*
	...
	Description:
	Run where a death is detected by bStats.
...
scriptName "SPY_bStats_fnc_onDeath";
...
{
	_null = [[5, (format ["%1 has died", _vName]), 0, ["SPY bStats", "Event Log"], false], "SPY_core_fnc_bMessage", true, false, false] call BIS_fnc_MP;
};
...
// CEH for hooks
_null = [[_v, _vUID, _vName, _vSide, _vPos, _vClass], "SPY_bStats_onDeath", 0, false] call SPY_core_fnc_cehExec;
