/*
	...
	Description:
	Run where a infantry team kill is detected by bStats.
...
scriptName "SPY_bStats_fnc_onTK_inf";

private ["_kWeaponToDisplay"];
...
{
	_null = [[5, (format ["%1 team killed %2 (%3)", _kName, _vName, ([_kWeaponToDisplay] call SPY_core_fnc_displayName)]), 0, ["SPY bStats", "Event Log"], false], "SPY_core_fnc_bMessage", true, false, false] call BIS_fnc_MP;
};
...
// CEH for hooks
_null = [[_v, _vUID, _vName, _vSide, _vPos, _vClass, _k, _kUID, _kName, _kSide, _KPos, _kClass, _kWeapon, _kVehicle, _assists, _score], "SPY_bStats_onTK_inf", 0, false] call SPY_core_fnc_cehExec;
